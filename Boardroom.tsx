          ...
          <Card className="shadow-lg border-0 bg-gradient-to-br from-white via-green-50/30 to-emerald-50/50 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="p-6 md:p-8 relative z-10">
              <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
                <motion.div 
                  className="p-4 bg-gradient-to-br from-green-500 via-emerald-500 to-green-600 rounded-xl shadow-lg relative overflow-hidden mx-auto md:mx-0"
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-gray-900 to-green-700 bg-clip-text text-transparent text-center md:text-left">
                    Your Startup Idea
                  </h3>
                  <motion.p 
