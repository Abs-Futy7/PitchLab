    ...
    <aside className="w-20 md:w-64 flex flex-col bg-gradient-to-b from-green-50 to-white border-r border-green-200 shadow-lg">
      <div className="h-20 flex items-center justify-center border-b border-green-200">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            {/* Mobile view logo */}
            <span className="md:hidden text-2xl font-black text-gray-800">
              P<span className="text-green-900 font-bold">L</span>
            </span>
            
            {/* Desktop view logo */}
            <span className="hidden md:inline text-3xl font-black text-gray-800">
      ...
      <nav className="flex-grow p-4 space-y-3">
        <Button
          ...
          className={cn(
            "w-full md:justify-start justify-center gap-3 h-12 rounded-xl font-medium transition-all duration-200",
        ...
        {agentList.map((agent) => (
          ...
          >
            <div className={cn(
              "p-1.5 rounded-lg bg-gradient-to-br shadow-sm flex items-center justify-center",
              agent.bgColor
            )}>
